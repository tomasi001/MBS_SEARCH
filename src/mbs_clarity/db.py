...
DB_PATH = os.getenv("MBS_DB_PATH", "/Users/thomasshields/MBS_Clarity/mbs.db")
...
def insert_meta(
    ...
    with get_conn() as conn:
        ...
        cur.execute(
            """
            INSERT INTO meta (source_path, source_hash, loaded_at, items_count, relations_count, constraints_count)
            VALUES (?, ?, ?, ?, ?, ?);
            """,
            (
                source_path,
